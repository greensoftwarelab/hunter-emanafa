...
public final class DebugMethodAdapter extends LocalVariablesSorter implements Opcodes {
    ...
    public DebugMethodAdapter(int cpu, String className, List<Parameter> parameters, String name, int access, String desc, MethodVisitor mv) {
    ...
    public void visitInsn(int opcode) {
        if ((debugMethod || debugMethodWithCustomLogger) && ((opcode >= IRETURN && opcode <= RETURN) || opcode == ATHROW)) {
            ...
            if(returnType != Type.VOID_TYPE || opcode == ATHROW) {
                ...
                if(debugMethod) {
                    mv.visitMethodInsn(INVOKESTATIC, "com/hunter/library/debug/ResultPrinter", "print", "(Ljava/lang/String;Ljava/lang/String;IJLjava/lang/Object;)V", false);
                } else {
